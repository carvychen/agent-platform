...
- Agents (this repo's and any external consumer) must obtain user tokens with audience equal to the MCP AAD app's Application ID URI. UI integrators need to know this.
